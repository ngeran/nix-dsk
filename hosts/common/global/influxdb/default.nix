  ...
  services.telegraf = {
    ...
    extraConfig = ''
      ...
      [[outputs.influxdb_v2]]
        ...
        token = "YOUR_GENERATED_INFLUXDB_TOKEN" # <-- REPLACE WITH THE TOKEN FROM STEP 2!
        organization = "juniper_org" # <-- REPLACE WITH YOUR ORGANIZATION NAME FROM STEP 2!
        bucket = "juniper_telemetry_bucket" # <-- REPLACE WITH YOUR BUCKET NAME FROM STEP 2!
