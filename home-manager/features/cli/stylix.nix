{ pkgs, inputs, ... }: {
  imports = [ inputs.stylix.homeModules.stylix ]; # Fixed: homeModules instead of homeManagerModules
  ...
  stylix = {
    ...
    fonts = { # Configures fonts
      ...
      monospace = {
        name = "MesloLGS Nerd Font Mono"; # Meslo LG Small (compact spacing)
        # Alternatives you can try:
        # name = "MesloLGM Nerd Font Mono"; # Meslo LG Medium (balanced spacing)
        # name = "MesloLGL Nerd Font Mono"; # Meslo LG Large (spacious)
